...
128×128×128 RectilinearGrid{Float64, Periodic, Periodic, Bounded} on Oceananigans.Architectures.CPU with 3×3×3 halo
...
├── grid: 128×128×128 RectilinearGrid{Float64, Periodic, Periodic, Bounded} on Oceananigans.Architectures.CPU with 3×3×3 halo
